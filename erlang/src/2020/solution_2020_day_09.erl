...
part2(List, Low, High, Sum, Value) when Sum < Value ->
    part2(List, Low, High + 1, Sum + lists:nth(High + 1, List), Value);
part2(List, Low, High, Sum, Value) when Sum > Value ->
    part2(List, Low + 1, High, Sum - lists:nth(Low, List), Value);
